...
export const ProductScreen = () => {
    ...
    return (
        <div className='main__screen container'>
            <h1 className='text-center'> <a className='text-white' target="_blank" href="https://gearthlogic.com/"> GEARTHLOGIC</a> <img src='https://gearthlogic.com/assets/img/icons8-world-100.png' className='main__screen_logo' /></h1>
